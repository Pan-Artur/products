...
var _renderPageJs = require("./js/render-page.js");
var _getProductsApiJs = require("./js/services/getProductsApi.js");
var _addProductModalJs = require("./js/modal/addProductModal.js");
var _getProductDataToAddJs = require("./js/modal/getProductDataToAdd.js");
var _editProductModalJs = require("./js/modal/editProductModal.js");
var _addProductApiJs = require("./js/services/addProductApi.js");
var _deleteProductsAPIJs = require("./js/services/deleteProductsAPI.js");
var _editProductApiJs = require("./js/services/editProductApi.js");

},{"./js/render-page.js":"1MBV5","./js/services/getProductsApi.js":"77vlQ","./js/modal/addProductModal.js":"2YeJ6","./js/modal/getProductDataToAdd.js":"3a9PZ","./js/modal/editProductModal.js":"kIgHJ","./js/services/addProductApi.js":"hwNgE","./js/services/deleteProductsAPI.js":"foncL","./js/services/editProductApi.js":"lG2kt"}],"1MBV5":[function(require,module,exports,__globalThis) {
var _getProductsApiJs = require("./services/getProductsApi.js");
var _layoutProductsJs = require("./layoutProducts.js");
var _deletingProductJs = require("./deletingProduct.js");
var _editProductModalJs = require("./modal/editProductModal.js");
const renderPage = async ()=>{
    try {
        const data = await (0, _getProductsApiJs.getProductsAPI)();
        (0, _layoutProductsJs.createMarkupProducts)(data);
        (0, _deletingProductJs.deleteProduct)();
        (0, _editProductModalJs.openModal)();
    } catch (error) {
        console.error(error);
    }
};
...
},{"./services/getProductsApi.js":"77vlQ","./layoutProducts.js":"gdYCx","./deletingProduct.js":"diZly","./modal/editProductModal.js":"kIgHJ"}],"77vlQ":[function(require,module,exports,__globalThis) {
...
},{}],"gdYCx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const createMarkupProducts = (data)=>{
    ...
    <li class="products-item" id="${id}">
        ...
        <button id="${id}" class="item-button delete-button">\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438}</button>
    </li>`).join("");
    listEl.innerHTML = markup;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"diZly":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteProduct", ()=>deleteProduct);
var _deleteProductsAPI = require("./services/deleteProductsAPI");
var _getProductsApi = require("./services/getProductsApi");
var _layoutProducts = require("./layoutProducts");
var _editProductModal = require("./modal/editProductModal");
const deleteProduct = ()=>{
    document.addEventListener("click", async (e)=>{
        if (e.target.classList.contains("delete-button")) {
            const deleteButtonEl = e.target;
            const productId = deleteButtonEl.parentElement.id;
            await (0, _deleteProductsAPI.deleteProductsAPI)(productId);
            const products = await (0, _getProductsApi.getProductsAPI)();
            (0, _layoutProducts.createMarkupProducts)(products);
            (0, _editProductModal.openModal)();
        }
    });
};

},{"./services/deleteProductsAPI":"foncL","./services/getProductsApi":"77vlQ","./layoutProducts":"gdYCx","./modal/editProductModal":"kIgHJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"foncL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kIgHJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../services/editProductApi":"lG2kt","../services/getProductsApi":"77vlQ","../layoutProducts":"gdYCx","../deletingProduct":"diZly","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lG2kt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "editProductsAPI", ()=>editProductsAPI);
const editProductsAPI = async (editedData, editedProductId)=>{
    try {
        const options = {
            method: "PUT",
